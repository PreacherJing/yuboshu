...
_core["default"].page({
      ...
      return _regeneratorRuntime2["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              this.isAuth = _context.sent;

              if (this.isAuth) {
                if (this.posType === 1) {
                  this.des = "\u6BCF\u5929\u6700\u591A\u53EF\u53D1\u5E031\u6B21\u8868\u767D";
                } else {
                  this.des = this.user.isAuth ? "\u6BCF\u5929\u6700\u591A\u53EF\u53D1\u5E03".concat(this.user.postDayLimit, "\u6B21\u52A8\u5F39") : '认证后,每天可获得5次动弹权限';
                }
              }
  ...
  methods: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 11;
                return _api.User.uploadVideo(this.video.url, function (progress) {
                  _this.video.progress = progress;
                  _this.video.maskHeight = _this.video.height - _this.video.height * (progress / 100);
                });
              ...
              case 21:
                _context2.next = 23;
                return _api.Post.qiniUploadFile(this.images);

              case 23:
                this.images = _context2.sent;
                _context2.next = 26;
                return _api.Post.release(this.userId, this.content, this.images.filter(function (img) {
                  return img.path != null;
                }), this.posType, mediaSrc, this.location, this.topic);
    ...
    onUploadVideo: function () {
      var _onUploadVideo = _asyncToGenerator(
      /*#__PURE__*/
      ...
      function onUploadVideo() {
        return _onUploadVideo.apply(this, arguments);
      }
