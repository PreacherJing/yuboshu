...
_core["default"].page({
        ...
        return _regeneratorRuntime2["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                _context5.next = 4;
                return _api.Post.rewardLogs(_this5.pageIndex, _this5.pageSize);
  ...
  }}}, models: {} }, {info: {"components":{"loading":{"path":"../components/loading/loading"},"user-item":{"path":"../components/user-item"},"no-more":{"path":"../components/no-more"},"empty":{"path":"../components/empty"},"mp-page":{"path":"../components/mp-page"},"comment-input":{"path":"../components/comment-input"}},"on":{"27-0":["retry"],"27-2":["action"]}}, handlers: {'27-0': {"retry": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        _vm.onRetry($event)
