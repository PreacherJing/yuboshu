...
_core["default"].page({
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.info.feeling.value = _this.groups[index].text;

                _this.onClose();

                _context.next = 5;
                return _api.User.setUserFiled('feeling', _this.groups[index].value);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (!_this2.info.nick.value) {
                  _context2.next = 6;
                  break;
                }

                _context2.next = 6;
                return _api.User.setUserFiled('nick', _this2.info.nick.value);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 5;
                return _api.User.setUserFiled('signature', _this3.info.signature.value);
        ...
        return _regeneratorRuntime2["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _this4.onBirthDayCancel();

                _this4.info.birthday.value = "".concat(_this4.years[_this4.birthday[0]], "-").concat(_this4.months[_this4.birthday[1]], "-").concat(_this4.days[_this4.birthday[2]]);
                _context4.next = 4;
                return _api.User.setUserFiled('birthday', _this4.info.birthday.value);
        ...
        return _regeneratorRuntime2["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _this5.onHomeTownCancel();

                _this5.info.hometown.value = "".concat(provinces[_this5.hometown[0]], " ").concat(_this5.citys[_this5.hometown[1]]);
                _context5.next = 4;
                return _api.User.setUserFiled('hometown', _this5.info.hometown.value);
  ...
  }), _defineProperty(_methods, "onUpload", function onUpload() {
    var _this6 = this;
