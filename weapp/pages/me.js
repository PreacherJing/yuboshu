...
_core["default"].page({
  ...
  methods: {
    ...
    bindingUserInfo: function () {
      var _bindingUserInfo = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime2["default"].mark(function _callee2(info) {
      ...
      function bindingUserInfo(_x) {
        return _bindingUserInfo.apply(this, arguments);
      }
