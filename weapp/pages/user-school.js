...
_core["default"].page({
  ...
  methods: {
    ...
    goVerify: function () {
      var _goVerify = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                _context.prev = 7;
                _iterator = this.info[Symbol.iterator]();
              ...
              case 31:
                _context.next = 33;
                return _api.User.setSchool(this.info[0].value, this.dataSoure[1].indexOf(this.info[1].value), this.info[2].value);
      ...
      function goVerify() {
        return _goVerify.apply(this, arguments);
      }
