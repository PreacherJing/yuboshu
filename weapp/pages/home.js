        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (_this.$app.$options.globalData.postId) {
                wx.navigateTo({
                  url: '/pages/post-details?id=' + _this.$app.$options.globalData.postId
                });
              }

              if (_this.$app.$options.globalData.commentId) {
                wx.navigateTo({
                  url: '/pages/post-comment?id=' + _this.$app.$options.globalData.commentId
                });
              }
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (_this2.hasInitTopic) {
                  _context2.next = 5;
                  break;
                }

                _context2.next = 4;
                return _this2.$refs.topic.init();

              case 4:
                _this2.hasInitTopic = true;

              case 5:
                _this2.$refs.topic.loadTrack();
              ...
              case 8:
                ...
                if (_this2.hasInitFollow) {
                  _context2.next = 13;
                  break;
                }

                _context2.next = 12;
                return _this2.$refs.follow.init();

              case 12:
                _this2.hasInitFollow = true;
