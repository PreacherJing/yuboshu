...
_core["default"].page({
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _api.Post.getUserQr(this.id);

            case 3:
              this.qrUrl = _context.sent;
              this.user = wx.getStorageSync('user');
              _context.next = 7;
              return _api.Post.getPost(this.id);

            case 7:
              this.post = _context.sent;
              ...
              _height = this.getHeight(ctx, pixelRatio);
              this.height = _height + 200; // ctx.setStrokeStyle('#ffd100')

              ctx.setFillStyle('#ffd100');
              ctx.fillRect(0, 0, screenWidth, this.height);
              this.drawBox(ctx, screenWidth, this.height);
              _context.next = 19;
              return this.drawUser(ctx);

            case 19:
              articleHeight = 76;

              if (this.post.origTxt.length) {
                articleHeight = this.drawArticle(ctx, this.post.origTxt, screenWidth - 100, 36, 116);
              }

              _context.next = 23;
              return this.drawImg(ctx, screenWidth - 90, articleHeight + 30, pixelRatio);

            case 23:
              imgHeight = _context.sent;
              this.drawDivider(ctx, screenWidth - 60, articleHeight + imgHeight + 60);
              _context.next = 27;
              return this.drawQr(ctx, articleHeight + imgHeight + 90, pixelRatio);
  ...
  methods: {
    ...
    drawUser: function () {
      var _drawUser = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime2["default"].mark(function _callee3(ctx) {
      ...
      function drawUser(_x2) {
        return _drawUser.apply(this, arguments);
      }
    ...
    drawImg: function () {
      var _drawImg = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime2["default"].mark(function _callee4(ctx, w, y, pixelRatio) {
      ...
      function drawImg(_x3, _x4, _x5, _x6) {
        return _drawImg.apply(this, arguments);
      }
    ...
    drawQr: function () {
      var _drawQr = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime2["default"].mark(function _callee5(ctx, y, pixelRatio) {
