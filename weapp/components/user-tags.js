...
_core["default"].component({
  ...
  watch: {
    show: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime2["default"].mark(function _callee(isShow) {
        ...
        return _regeneratorRuntime2["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                tagData = this.$app.$options.globalData.tagData;
                ...
                _context2.next = 5;
                return _api.User.addLabels(this.userId, tagData.parent, tagData.labels);
        ...
        wx.navigateTo({
          ...
          events: {
            acceptDataFromOpenedPage: function () {
                ...
                return _regeneratorRuntime2["default"].wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        _this.tags[res.parent] = res.labels;
                        _context3.next = 3;
                        return _api.User.addLabels(_this.userId, res.parent, res.labels);
              ...
              function acceptDataFromOpenedPage(_x2) {
        ...
        return _regeneratorRuntime2["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return _api.User.getLabelsForUser(this.userId);
