...
_core["default"].component({
  ...
  watch: {
    commentId: function () {
      var _commentId = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                this.hasMore = true;
                _context2.next = 5;
                return _api.Post.getReplys(this.commentId, 1, this.pageSize);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                _context3.next = 5;
                return _api.Post.getReplys(this.commentId, this.pageIndex, this.pageSize);
