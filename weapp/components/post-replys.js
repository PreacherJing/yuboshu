...
_core["default"].component({
  ...
  }}}, models: {} }, {info: {"components":{"loading":{"path":"loading/loading"},"comment-item":{"path":"post-comment-item"},"mp-page":{"path":"mp-page"},"empty":{"path":"empty"},"no-more":{"path":"no-more"}},"on":{"78-0":["itemTap"],"78-1":["action"]}}, handlers: {'78-0': {"itemTap": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        _vm.onItemTap($event)
