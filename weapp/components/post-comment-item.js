...
_core["default"].component({
  ...
  methods: {
    ...
    onThumbs: function () {
      var _onThumbs = _asyncToGenerator(
      /*#__PURE__*/
        ...
        return _regeneratorRuntime2["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 5:
                _context2.next = 7;
                return _api.Post.thumbs(this.item.postId, this.item.commentId, this.item.id, this.actionType + 1, this.item.userId, this.item.hasLike);
      ...
      function onThumbs() {
        return _onThumbs.apply(this, arguments);
      }
