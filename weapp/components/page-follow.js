...
_core["default"].component({
  ...
  }}}, models: {} }, {info: {"components":{"mp-page":{"path":"mp-page"},"post-item":{"path":"post-item"},"user-recommend":{"path":"user-recommend"}},"on":{"66-0":["scrolltolower","retry","refresh"]}}, handlers: {'66-0': {"scrolltolower": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        _vm.onScrolltolower($event)
